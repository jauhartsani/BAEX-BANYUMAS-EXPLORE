        ...
        <div class="container"><a class="navbar-brand d-flex align-items-center fw-bold fs-2" href="#"> <img class="d-inline-block align-top img-fluid" src="assets/img/gallery/logo-icon.png" alt="" width="50" />
          ...
          <div class="collapse navbar-collapse border-top border-lg-0 mt-4 mt-lg-0" id="navbarSupportedContent">
            <ul class="navbar-nav ms-auto pt-2 pt-lg-0">
              ...
              <li class="nav-item"><a class="nav-link text-600" href="../user/index.php">Booking </a></li>
            </ul>
          </div>
        </div>
      </nav>
...
<h1 class="fw-bold fs-md-3 fs-lg-4 fs-xl-5"> Data Booking Tiket BAEX </h1></p>
<div class="thin"> ( "Apabila data telah tampil maka proses booking berhasil" ) </div></p>
	<br/>
	<br>
	<br>
    <style>
          ...
          <div class="row flex-center">
            <div class="col-auto mb-4">
              <ul class="list-unstyled list-inline mb-0">
                ...
                <li class="list-inline-item me3 me-sm-4"><a class="text-dark text-decoration-none" href="/booking/index.html">Booking</a></li>
